# safe-document-save Specification

## Purpose

Define the document lifecycle and safe-save contract for docx-knife: minimal open/save API, source drift detection, single previous-version backup, main-part-only ZIP rewriting, temporary-package validation, atomic destination replacement, a stable save result, untouched XML fidelity semantics, and protection of unsupported structures.
