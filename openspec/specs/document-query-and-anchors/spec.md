# document-query-and-anchors Specification

## Purpose

Define how docx-knife discovers editable paragraphs, assigns instance-local IDs as the only write coordinates, exposes listing, search, read, and text-discovery APIs, and reports table position metadata without letting positions or diagnostic identifiers become targeting keys.
