# content-sources-and-normalization Specification

## Purpose

Define how docx-knife resolves paragraph content from literal values and controlled references (JSONPath, file, shell-free command), how visible-mode newlines expand into paragraphs and breaks, and the optional Chinese/Latin text normalization rules that keep prose deterministic without corrupting protected tokens.
