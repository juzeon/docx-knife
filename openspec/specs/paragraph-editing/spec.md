# paragraph-editing Specification

## Purpose

Define whole-paragraph write operations for docx-knife: ordered insertion, one-to-many replacement, multi-target deletion, a fluent paragraph-object API, visible-mode format inheritance, raw XML fragment mode, content-mode consistency, destructive-change warnings, and equivalent behavior in table cells.
